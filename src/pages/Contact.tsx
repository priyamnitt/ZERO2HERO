            ...
            <div className="lg:pr-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-brand-blue to-brand-purple hover:opacity-90 py-6"
                >
              ...
              <div className="bg-gray-50 p-8 rounded-lg space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Education Street, Bangalore, India 560001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@zerotohero.com</p>
                    <p className="text-gray-600">support@zerotohero.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Our support team is available for live chat during office hours.</p>
                  </div>
                </div>
              </div>
